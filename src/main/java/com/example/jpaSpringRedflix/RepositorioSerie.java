...
@Repository
public interface RepositorioSerie extends JpaRepository<Serie, Integer> {    //la interface Repositorio, hereda de Jpa... y va a manipular objetos de tipo usuario, y sub llave primaria en un string
